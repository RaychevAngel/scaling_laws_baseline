...
list1 = [
    (2, 16, 0.205), (3, 11, 0.236), (3, 21, 0.248), (4, 16, 0.291),
    (5, 13, 0.291), (6, 11, 0.287), (7, 9, 0.203), (4, 32, 0.289),
    (5, 26, 0.305), (6, 21, 0.331), (7, 18, 0.334), (8, 16, 0.336),
    (9, 14, 0.309), (5, 51, 0.318), (6, 43, 0.342), (7, 37, 0.339),
    (8, 32, 0.364), (9, 28, 0.360), (10, 26, 0.372), (6, 85, 0.318),
    (8, 64, 0.359), (10, 51, 0.385), (12, 43, 0.386), (14, 37, 0.402)
]

compressed_list1 = [(32, 0.236), (64, 0.291), (128, 0.336), (256, 0.372), (512, 0.402)]

list2 = [
    (2, 16, 0.309), (3, 11, 0.347), (3, 21, 0.349), (4, 16, 0.387),
    (5, 13, 0.394), (6, 11, 0.408), (7, 9, 0.401), (4, 32, 0.382),
    (5, 26, 0.396), (6, 21, 0.419), (7, 18, 0.422), (8, 16, 0.445),
    (9, 14, 0.450), (5, 51, 0.401), (6, 43, 0.417), (7, 37, 0.439),
    (8, 32, 0.440), (9, 28, 0.456), (10, 26, 0.464), (6, 85, 0.423),
    (8, 64, 0.433), (10, 51, 0.477), (12, 43, 0.489), (14, 37, 0.501),
    (16, 32, 0.489), (10, 102, 0.473), (13, 79, 0.490), (16, 64, 0.514),
]

compressed_list2 = [(32, 0.347), (64, 0.408), (128, 0.450), (256, 0.464), (512, 0.501), (1024, 0.514)]

list3 = [
    (2, 16, 0.326), (3, 11, 0.350), (3, 21, 0.362), (4, 16, 0.382),
    (5, 13, 0.394), (6, 11, 0.396), (7, 9, 0.393), (4, 32, 0.379),
    (5, 26, 0.394), (6, 21, 0.404), (7, 18, 0.420), (8, 16, 0.424),
    (9, 14, 0.432), (5, 51, 0.402), (6, 43, 0.410), (7, 37, 0.416),
    (8, 32, 0.408), (9, 28, 0.414), (10, 26, 0.426), (11, 23, 0.441), 
    (12, 21, 0.444), (6, 85, 0.408), (8, 64, 0.428), (10, 51, 0.445), 
    (12, 43, 0.456), (14, 37, 0.463), (16, 32, 0.465), (10, 102, 0.446), 
    (13, 79, 0.459), (16, 64, 0.458), (19, 54, 0.477)
    ]

compressed_list3 = [(32, 0.350), (64, 0.396), (128, 0.432), (256, 0.444), (512, 0.465), (1024, 0.477)]

list4 = [
    (2, 16, 0.313), (3, 11, 0.356), (3, 21, 0.348), (4, 16, 0.389),
    (5, 13, 0.394), (6, 11, 0.419), (7, 9, 0.411), (4, 32, 0.370),
    (5, 26, 0.399), (6, 21, 0.416), (7, 18, 0.424), (8, 16, 0.419),
    (9, 14, 0.429), (5, 51, 0.386), (6, 43, 0.395), (7, 37, 0.428),
    (8, 32, 0.420), (9, 28, 0.447), (10, 26, 0.445), (11, 23, 0.441), 
    (12, 21, 0.432), (6, 85, 0.407), (8, 64, 0.431), (10, 51, 0.439), 
    (12, 43, 0.460), (14, 37, 0.474), (16, 32, 0.476), (10, 102, 0.442), 
    (13, 79, 0.461), (16, 64, 0.456), (19, 54, 0.452)
]

compressed_list4 = [(32, 0.356), (64, 0.419), (128, 0.429), (256, 0.447), (512, 0.476), (1024, 0.461)]
